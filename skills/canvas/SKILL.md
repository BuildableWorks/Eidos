...
- `--vault` sets the root the embed/file paths are relative to (default: the root — a root is plausibly the vault). `--out` sets the output path; by default the canvas is named "Blueprint Map" in the framework's naming convention (`blueprint-map.canvas` under the default kebab-case).
...
The generated `.canvas` is a **top-level document** — the spatial view of the whole. After writing it, add it to `_eidos/Framework.md` under `## Top-Level`; the script prints a ready-made bullet. `configure` keeps that section current.
...
{
  "nodes": [
    { "id": "group:Scenes", "type": "group", "x": 0, "y": 0, "width": 840, "height": 830, "label": "Scenes" },
    { "id": "group:Scenes/Act I", "type": "group", "x": 40, "y": 70, "width": 760, "height": 330, "label": "Playback" },
    { "id": "cold-open", "type": "text", "text": "**[[Scenes/Act I/Cold Open|Cold Open]]**\n\n![[Scenes/Act I/Cold Open#Logline]]", "x": 80, "y": 140, "width": 320, "height": 220, "color": "4" },
