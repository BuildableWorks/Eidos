...
python3 <skill>/build-canvas.py <definition-root> --color Frames:6 --color <Collection>:4   # the agreed color schema
python3 <skill>/build-canvas.py <definition-root> --collection <Collection> --collection Frames --out "Framework Map.canvas"
```
