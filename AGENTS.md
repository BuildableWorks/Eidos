...
- **`configure`** — add a collection or flavor, add/rename/retire a custom property or a Vocabulary term, snapshot the root as a version when asked, and keep the Framework index current
