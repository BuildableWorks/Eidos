...
- **AC4:** For a signed-in viewer, playback offers to resume from their saved position (see [Resume Playback](resume-playback.md)).
...
- [Resume Playback](resume-playback.md) — supplies the position AC4 resumes from.
