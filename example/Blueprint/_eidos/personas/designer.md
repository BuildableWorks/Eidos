...
- **Decisions:** contribute to Audience, Behaviors, and external-interface criteria; defer architecture and data-model calls to the Registry Owner / Developer.
...
**Technical capacity** is low by default for this persona; raise it if the designer is comfortable with the stack, and they'll get more mechanism.
