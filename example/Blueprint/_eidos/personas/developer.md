...
Builds the product from its specs. Reads a spec to answer "what am I building, exactly?" and to find the edges, the dependencies, and the things still undecided.
...
**Experience with the scope** sets how much orientation to give; **technical capacity** is high by default for this persona, but honored if calibrated down.
