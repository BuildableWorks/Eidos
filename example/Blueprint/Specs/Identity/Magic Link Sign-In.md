...
- **AC5:** An unknown email produces the same response as a known one — and the sameness is not defeatable by timing — so the form never reveals who has an account.
